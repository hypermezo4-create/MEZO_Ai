...
export class ErrorBoundary extends Component<{ children: ReactNode }, State> {
  ...
  componentDidCatch(error: Error, info: { componentStack?: string }) {
    console.error("[MEZO] render crash:", error, info.componentStack)
  ...
  render() {
    ...
    return <div style={{ padding: "2rem", fontFamily: "ui-monospace, monospace", color: "#e5e7eb", background: "#0b0f10", minHeight: "100vh" }}>
      <h2 style={{ color: "#4ed6a5" }}>MEZO could not render this view</h2>
      <p style={{ color: "#9ca3af" }}>Try refreshing. Running tasks continue on the remote runner.</p>
